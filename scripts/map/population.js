...
d3.selectAll('.button-main').on('click', handleButtonClick);

function handleButtonClick() {
    d3.select(this)
        .transition()
        .duration(500) // set the duration of the transition in ms
        // .style('background-color', 'red'); // set the new style for the button
}
